...
public interface Local1000SectionRepo
    extends JpaRepository<Flow1000Section, Long>, JpaSpecificationExecutor<Flow1000Section> {
  ...
  /**
   * Returns a single entity matching the given {@link Specification} or
